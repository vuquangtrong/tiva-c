...
{
    MainMenu::getInstance().hanldeAction(MainMenu::ACTION_DEC);
}
void ButtonRight::onDoubleClick()
{
    MainMenu::getInstance().hanldeAction(MainMenu::ACTION_DOWN);
}
void ButtonRight::onHold()
{
    MainMenu::getInstance().hanldeAction(MainMenu::ACTION_EXIT);
}
