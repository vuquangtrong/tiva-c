...
{
    MainMenu::getInstance().hanldeAction(MainMenu::ACTION_INC);
}
void ButtonLeft::onDoubleClick()
{
    MainMenu::getInstance().hanldeAction(MainMenu::ACTION_UP);
}
void ButtonLeft::onHold()
{
    MainMenu::getInstance().hanldeAction(MainMenu::ACTION_ENTER);
}
